  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed top-[50%] left-[50%] z-50 grid w-[min(92vw,560px)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-2xl border border-border bg-background p-5 shadow-[0_28px_90px_-36px_rgba(15,23,42,0.45)] duration-200 data-[state=open]:animate-in sm:p-6",
          className,
        )}
        {...props}
      >
